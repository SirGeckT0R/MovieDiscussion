namespace DiscussionServiceDomain.Models
{
    public class Discussion : IdModel
    {
        ...
        public Discussion(string title, string description, DateTime startAt, Guid createdBy, bool isActive, ICollection<Guid> subscribers, ICollection<Message> messages)
        {
            Title = title;
